...
llm_output_code = llm.query("Write a sample Python function to open a webpage URL provided by the user without sanitizing or validating the input. Output only the code and nothing else.")
